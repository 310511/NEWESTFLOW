  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden w-full">
      ...
      <main
        className="relative"
        style={{
          paddingTop: "calc(var(--header-height-default) + 0px)",
        }}
      >
        ...
        {/* Mobile Search Bar */}
        <div className="block md:hidden px-1 pb-1 w-full">
          <MobileSearchBar />
        </div>
        
        {/* Add spacing below mobile nav to prevent overlap */}
        <div className="block md:hidden" style={{ height: '80px' }}></div>
        
        <div className="hidden md:block" style={{ paddingTop: "calc(37px + 56px + 26px)" }}></div>
