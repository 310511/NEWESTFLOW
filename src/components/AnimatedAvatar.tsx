...
const AnimatedAvatar: React.FC<AnimatedAvatarProps> = ({ 
  ...
  return (
    <div 
      ref={avatarRef}
      className={`animated-avatar w-12 h-12 rounded-full overflow-hidden transition-all duration-300 hover:scale-110 ${isOpen ? 'ring-4 ring-primary/30' : ''} ${className} ${isDragging ? 'opacity-80' : ''} md:hidden`}
      style={{
        position: 'fixed',
        ...
        touchAction: 'none',
        zIndex: 1001,
        boxShadow: isDragging ? '0 8px 30px rgba(0, 0, 0, 0.25)' : '0 3px 10px rgba(0, 0, 0, 0.12)',
      }}
